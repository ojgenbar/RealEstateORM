...
sup.flat = Flat(area=89)
sup.flat.address = Address(geom='SRID=3395; POINT(400000 500000)', ruAddress=u'А я день рождения не буду справлять!')
sup.flat.address.district = District(name=u'Адмиралтейский район')
